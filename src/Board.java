...
public class Board extends JFrame {
	...
	public Board() {
		...
		// a8.setIcon(new ImageIcon("src\\resources\\bishop_black.png"));
		...
		// b8.setOpaque(true);
		// b8.setIcon(new ImageIcon("src\\resources\\knight_black.png"));
		...
		// c8.setIcon(new ImageIcon("src\\resources\\rook_black.png"));
		...
		// d8.setOpaque(true);
		// d8.setIcon(new ImageIcon("src\\resources\\queen_black.png"));
		...
		// e8.setIcon(new ImageIcon("src\\resources\\king_black.png"));
		...
		// f8.setOpaque(true);
		// f8.setIcon(new ImageIcon("src\\resources\\rook_black.png"));
		...
		// g8.setIcon(new ImageIcon("src\\resources\\knight_black.png"));
		...
		// h8.setOpaque(true);
		// h8.setIcon(new ImageIcon("src\\resources\\bishop_black.png"));
		...
		// }
		// });
		// a7.setIcon(new ImageIcon("src\\resources\\pawn_black.png"));
		...
		// b7.setIcon(new ImageIcon("src\\resources\\pawn_black.png"));
		...
		// c7.setOpaque(true);
		// c7.setIcon(new ImageIcon("src\\resources\\pawn_black.png"));
		...
		// d7.setIcon(new ImageIcon("src\\resources\\pawn_black.png"));
		...
		// e7.setOpaque(true);
		// e7.setIcon(new ImageIcon("src\\resources\\pawn_black.png"));
		...
		// f7.setIcon(new ImageIcon("src\\resources\\pawn_black.png"));
		...
		// g7.setOpaque(true);
		// g7.setIcon(new ImageIcon("src\\resources\\pawn_black.png"));
		...
		// h7.setIcon(new ImageIcon("src\\resources\\pawn_black.png"));
		...
		// a2.setIcon(new ImageIcon("src\\resources\\pawn_white.png"));
		...
		// b2.setOpaque(true);
		// b2.setIcon(new ImageIcon("src\\resources\\pawn_white.png"));
		...
		// c2.setIcon(new ImageIcon("src\\resources\\pawn_white.png"));
		...
		// d2.setOpaque(true);
		// d2.setIcon(new ImageIcon("src\\resources\\pawn_white.png"));
		...
		// e2.setIcon(new ImageIcon("src\\resources\\pawn_white.png"));
		...
		// f2.setOpaque(true);
		// f2.setIcon(new ImageIcon("src\\resources\\pawn_white.png"));
		...
		// g2.setIcon(new ImageIcon("src\\resources\\pawn_white.png"));
		...
		// h2.setOpaque(true);
		// h2.setIcon(new ImageIcon("src\\resources\\pawn_white.png"));
		...
		// a1.setIcon(new ImageIcon("src\\resources\\bishop_white.png"));
		...
		// b1.setIcon(new ImageIcon("src\\resources\\knight_white.png"));
		...
		// c1.setIcon(new ImageIcon("src\\resources\\rook_white.png"));
		...
		// d1.setIcon(new ImageIcon("src\\resources\\queen_white.png"));
		...
		// e1.setIcon(new ImageIcon("src\\resources\\king_white.png"));
		...
		// f1.setIcon(new ImageIcon("src\\resources\\rook_white.png"));
		...
		// g1.setIcon(new ImageIcon("src\\resources\\knight_white.png"));
		...
		// h1.setIcon(new ImageIcon("src\\resources\\bishop_white.png"));
		...
		// board[0][0] = new ChessSquare(new Rook(0,0,false));
		// board[0][1] = new ChessSquare(new Knight(0,1,false));
		// board[0][2] = new ChessSquare(new Bishop(0,2,false));
		// board[0][3] = new ChessSquare(new King(0,3,false));
		// board[0][4] = new ChessSquare(new Queen(0,4,false));
		// board[0][5] = new ChessSquare(new Bishop(0,5,false));
		// board[0][6] = new ChessSquare(new Knight(0,6,false));
		// board[0][7] = new ChessSquare(new Rook(0,7,false));
		// for (int i = 0; i < board.length; i++) {
		// board[1][i] = new ChessSquare(new Pawn(1,i,false));
		// }
		//
		// for (int i = 0; i < 2; i++) {
		// for (int j = 0; j <board.length; j++) {
		...
		//
		//
		// board[7][0] = new ChessSquare(new Rook(7,0,true));
		// board[7][1] = new ChessSquare(new Knight(7,1,true));
		// board[7][2] = new ChessSquare(new Bishop(7,2,true));
		// board[7][3] = new ChessSquare(new Queen(7,3,true));
		// board[7][4] = new ChessSquare(new King(7,4,true));
		// board[7][5] = new ChessSquare(new Bishop(7,5,true));
		// board[7][6] = new ChessSquare(new Knight(7,6,true));
		// board[7][7] = new ChessSquare(new Rook(7,7,true));
		// for (int i = 0; i < board.length; i++) {
		// board[6][i] = new ChessSquare(new Pawn(1,i,true));
		// }
		// for (int i = 6; i < 8; i++) {
		// for (int j = 0; j <board.length; j++) {
		// board[i][j].setIcon(board[i][j].getIcon());
		// board[i][j].setOpaque(true);
		//
		// //contentPane.add(board[i][j]);
		// }
	...
	private boolean isKingThreatened(int x, int y, boolean isWhite) {
		for (int i = 0; i < board.length; i++) {
			for (int j = 0; j < board.length; j++) {
				if (!getPlayingFigure(i, j).isWhite) {
